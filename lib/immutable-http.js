...
var Http = (function () {
  function Http() {
    ...
    var bodyProcessor = arguments[7] === undefined ? function (body) {
      return body;
    } : arguments[7];
    return (function () {
      _classCallCheck(_this, Http);
      ...
      _this.responseType = function () {
        return _responseType;
      };

      var _dynamicSegments = dynamicSegments;

      _this.dynamicSegments = function () {
  ...
  _prototypeProperties(Http, null, {
    ...
    withAjax: {
      ...
      value: function withAjax() {
        return this.withHeader("Content-Type", "application/json").withResponseType("json").withBodyProccessor(JSON.stringify);
      },
      writable: true,
      configurable: true
    },
...
var submit = function (http) {
  return new Promise(function (fulfill, reject) {
    ...
    addHeaders(xmlhttp, http.headers());
    setResponseType(xmlhttp, http.responseType());
    var body = undefined.bodyProcessor()(undefined.body());
    xmlhttp.send(body);
  });
};

...
var Http = (function () {
  function Http() {
    ...
    var dynamicSegments = arguments[5] === undefined ? [] : arguments[5];
  ...
  _prototypeProperties(Http, null, {
    withUrl: {
      ...
      value: function withUrl(url) {
        return new Http(url, this.method(), this.headers(), this.body(), this.responseType(), this.dynamicSegments(), this.queryParams());
      },
      writable: true,
      configurable: true
    },
    withMethod: {
      ...
      value: function withMethod(method) {
        return new Http(this.url(), method, this.headers(), this.body(), this.responseType(), this.dynamicSegments(), this.queryParams());
      },
      writable: true,
      configurable: true
    },
    withHeader: {
      ...
      value: function withHeader(header, value) {
        ...
        return new Http(this.url(), this.method(), headers, this.body(), this.responseType(), this.dynamicSegments(), this.queryParams());
      },
      writable: true,
      configurable: true
    },
    withBody: {
      ...
      value: function withBody(body) {
        return new Http(this.url(), this.method(), this.headers(), body, this.responseType(), this.dynamicSegments(), this.queryParams());
      },
      writable: true,
      configurable: true
    },
    withResponseType: {
      ...
      value: function withResponseType(responseType) {
        return new Http(this.url(), this.method(), this.headers(), this.body(), responseType, this.dynamicSegments(), this.queryParams());
      },
      writable: true,
      configurable: true
    },
    withDynamicSegment: {
      value: function withDynamicSegment(segment, value) {
        ...
        return new Http(this.url(), this.method(), this.headers(), this.body(), this.responseType(), dynamicSegments, this.queryParams());
      },
      writable: true,
      configurable: true
    },
    withParam: {
      value: function withParam(name, value) {
        ...
        return new Http(this.url(), this.method(), this.headers(), this.body(), this.responseType(), this.dynamicSegments(), queryParams);
      },
      writable: true,
      configurable: true
    },
...
var mixinDynamicSegmentsValues = function (url, dynamicSegments) {
  dynamicSegments.forEach(function (segment) {
